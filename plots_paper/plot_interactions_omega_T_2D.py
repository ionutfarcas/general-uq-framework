...
if __name__ == '__main__':
	...
	text_colors = [text_color2, text_color1, text_color3, text_color4]
	...
	colors = [patch_color2, patch_color1, patch_color3, patch_color4]
...
fig_name = 'figures/interactions_wT_2D.pdf'
