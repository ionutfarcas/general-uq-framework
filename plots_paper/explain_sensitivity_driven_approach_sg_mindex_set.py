...
def draw_cube_refinement(ax, multiindex, alpha=1.0, color='red', dim=3):
	...
	# arr = Arrow3D([0.5, 2], [0.5, 0.5], 
	#             [8.5, 8.5], mutation_scale=10, 
...
if __name__ == '__main__':
	...
	old_index_set 		= np.load('testcase_showcase_approach/old_index_set.npy')
	active_set 			= np.load('testcase_showcase_approach/active_set.npy')
