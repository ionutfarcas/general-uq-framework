...
if __name__ == '__main__':
	...
	ax.bar3d(xpos, ypos, zpos, dx, dy, local_sobol_indices, color=color1)
	local = Rectangle((0, 0), 1, 1, fc=color1)

	ax.bar3d(xpos, ypos, local_sobol_indices, dx, dy, interactions, color=color2)
	interactions = Rectangle((0, 0), 1, 1, fc=color2)


	params = [r'$T_{e}$', r'$n_{e}$', r'$\omega_{T_e}$', r'$\omega_{n_e}$', r'$\tau$', r'$Z_{\mathrm{eff}}$', r'$q$', r'$\hat{s}$']
	...
	# ax.set_title('A. Magnitude of the first-order and \n interaction sensitivity indices')
